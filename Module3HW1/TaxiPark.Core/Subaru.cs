...
{
    public class Subaru : LightCar
    {
        private Subaru(Engine engine) : base(engine)
        {
        }

        public Subaru(Engine engine, ConsoleColor color, decimal price, int speed, IMovableWithDifferentWheels mov) : this(engine)
        {
            Color = color;
            Name = "Subaru";
            Price = price;
        ...
        public override int FuelConsumption { get => 12; }
